...
<br/><br/>
                    ...
                    <div className="mb-10">
                        <button onClick={() => open()} className={'bg-[#0051b1] text-white text-xl py-4 px-14 rounded-xl transition-transform hover:translate-y-[-2px]'}>Записаться на консультацию</button>
                    </div>
                    <div className="">
            ...
            {
                modal && <Modal title={'Консультация'} onClose={() => close()}>
                <ContactForm/>
                </Modal>
            }
        </div>
